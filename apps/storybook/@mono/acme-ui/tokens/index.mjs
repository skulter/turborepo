const tokens = {
  ...
  "fontWeights.normal": {
    "value": "var(--font-weights-normal)",
    "variable": "var(--font-weights-normal)"
  },
  "fontWeights.medium": {
    "value": "var(--font-weights-medium)",
    "variable": "var(--font-weights-medium)"
  },
  "fontWeights.bold": {
    "value": "var(--font-weights-bold)",
  ...
  "colors.buttonBackground": {
    "value": "var(--colors-button-background)",
    "variable": "var(--colors-button-background)"
  },
  "colors.buttonBackgroundHover": {
    "value": "var(--colors-button-background-hover)",
    "variable": "var(--colors-button-background-hover)"
  },
  "colors.buttonText": {
    "value": "var(--colors-button-text)",
    "variable": "var(--colors-button-text)"
  },
  "fontSizes.body": {
  ...
  "fontSizes.heading": {
    "value": "var(--font-sizes-heading)",
    "variable": "var(--font-sizes-heading)"
  },
  "fontWeights.body": {
    "value": "var(--font-weights-body)",
    "variable": "var(--font-weights-body)"
  },
  "fontWeights.heading": {
    "value": "var(--font-weights-heading)",
    "variable": "var(--font-weights-heading)"
  },
  "space.small": {
    "value": "var(--space-small)",
    "variable": "var(--space-small)"
  },
  "space.medium": {
    "value": "var(--space-medium)",
    "variable": "var(--space-medium)"
  },
  "space.large": {
    "value": "var(--space-large)",
    "variable": "var(--space-large)"
  },
  "spacing.-1": {
